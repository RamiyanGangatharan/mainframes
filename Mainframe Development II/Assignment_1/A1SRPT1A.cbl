      ...
      *    KC03D09.DCMAFD02.A1.INPUT.DATA - INPUT FILE FOR THE PROGRAM
           SELECT INPUT-FILE
           ASSIGN TO INFILE
           ORGANIZATION IS SEQUENTIAL.

      *    KC03D09.DCMAFD02.A1.RPT1A.OUT - OUTPUT FILE #1 (.OUT)
           SELECT OUTPUT-FILE
           ASSIGN TO OUTFILE
           ORGANIZATION IS SEQUENTIAL.

      *    KC03D09.DCMAFD02.A1.NG1B.DATA - OUTPUT FILE #2 (DATA)
           SELECT NOUTPUT-FILE
           ASSIGN TO NOUTFILE
           ORGANIZATION IS SEQUENTIAL.
      ...
      * CONTACTING THE JCL TO WRITE THE NON-GRADUATE COLUMNS ONTO THIS
      * DATA FILE (NG1B)
       FD NOUTPUT-FILE
           RECORDING MODE IS F
      ...
      * A PARAGRAPH TO MOVE NON-GRADUATES TO A DATA FILE.
       300-SPLITTER.
